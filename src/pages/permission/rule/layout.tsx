...
const tablecolumnfield=[
    ...
    {title:'接口',dataIndex:'api',key:'api',hideInColumn:false,hideInSearch:false,type:COLUMN_CONTENT},
    {title:'请求方法',dataIndex:'method',key:'method',hideInColumn:false,hideInSearch:false,type:COLUMN_TEXT},
    {title:'函数',dataIndex:'func',key:'func',hideInColumn:false,hideInSearch:false,type:COLUMN_TEXT},
    {title:'所属菜单',dataIndex:'menu_name',key:'menu_name',hideInColumn:false,hideInSearch:true,type:COLUMN_TEXT},
...
const formfield=[
    ...
    {title:'接口',dataIndex:'api',key:'api',disabled:false,type:FORM_FIELD_TEXT,rules:[
        {required: true,message: '必填项！'}
    ]},
    {title:'请求方法',dataIndex:'method',key:'method',disabled:false,type:FORM_FIELD_TEXT,rules:[
        {required: true,message: '必填项！'}
    ]},
    {title:'函数',dataIndex:'func',key:'func',disabled:false,type:FORM_FIELD_TEXT,rules:[
        {required: true,message: '必填项！'}
    ]}
]
